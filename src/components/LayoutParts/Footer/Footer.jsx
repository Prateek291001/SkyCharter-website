...
const Footer = () => {
    return (
                    ...
                    <div className='flex flex-col py-8 w-full md:w-auto'>
                        <ul className='   items-center    justify-center'>
                            <li className='mt-4 flex items-center'>
                                ...
                                <div className="ml-4">
                                    <h1 className='font-serif text-sm text-[#0B2545]'>CALL DIRECT
                                        <span className='text-orange-400 font-semibold text-2xl'><br />+(91)212-279-1095</span>
                                    </h1>
                                </div>
                            </li>
                            <li className='mt-8 flex items-center'>
                                ...
                                <div className="ml-4">
                                    <h1 className='font-serif text-sm text-[#0B2545]'>FOR MEMBERS
                                        <span className='text-orange-400 font-semibold text-2xl'><br />+(91)844-251-055</span>
                                    </h1>
                                </div>
                            </li>
                        </ul>
                        <NavLink to="/Form">
                            <button className='w-60 h-16 mt-8 bg-[#FF6D2E] rounded-md text-white font-semibold text-xl hover:bg-orange-700'>
                                Request A Quote
                            </button>
                        </NavLink>
                    </div>
                    <div className="space-y-1 mt-4 w-full md:w-auto">
                        <h2 className="text-[#0B2545] text-lg font-semibold">SkyCharter Services</h2>
        ...
        <div className="mt-6 border-t border-orange-500 pt-8 flex flex-col lg:flex-row lg:justify-between lg:items-center bg-gray-300 w-full h-fit ">
                    <div className=' '>
                        <p className="text-gray-500 text-sm ">© 2024 SkyCharter. All Rights Reserved |
