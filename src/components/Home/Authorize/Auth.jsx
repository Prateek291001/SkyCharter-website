...
import Img6 from '../Authorize/AuthorizeImages/OIP.jpeg';
  ...
  return (
    <div className='bg-white'>
      <h1 className='mt-16 text-3xl font-semibold text-[#0b2545] text-center md:text-xl lg:text-3xl xl:text-4xl'>
        Got Questions? Contact us using a method below:
      </h1>
      ...
      <div className='flex flex-col md:flex-row my-4 w-full items-center justify-evenly space-y-5 md:space-y-0 md:space-x-5 p-5 md:p-20 cursor-pointer'>
        <div className='relative text-center' data-aos='fade-up'>
          ...
          <p className='text-lg font-semibold text-orange-400'>(+91)212 279-1095</p>
        </div>
        <div className='relative text-center' data-aos='fade-up'>
          <img src={Img2} alt='Call Us Toll Free' className='w-24 h-20 mx-auto' />
          <h1 className='font-bold text-xl text-[#0b2545] mt-4'>FOR MEMBERS</h1>
          <p className='text-lg font-semibold text-orange-400'>(+91)844-251-0555</p>
        </div>
        <div className='relative text-center' data-aos='fade-up'>
          <img src={Img3} alt='Text Us to Chat' className='w-24 h-20 mx-auto' />
          <h1 className='font-bold text-xl text-[#0b2545] mt-4'>CONNECT US VIA CHAT</h1>
          <p className='text-lg font-semibold text-orange-400'>(+91)212-279-1095</p>
        </div>
        <div className='relative text-center' data-aos='fade-up'>
          <img src={Img4} alt='Email Us' className='w-24 h-20 mx-auto' />
          <h1 className='font-bold text-xl text-[#0b2545] mt-4'>EMAIL US</h1>
          <p className='text-lg font-semibold text-orange-400'>Info@SkyCharter.com</p>
        </div>
      </div>
      ...
      <div className="w-full h-screen parallax-container">
        ...
        <div className="h-full flex flex-col justify-center items-center relative z-40">
          ...
          <div className="flex space-x-4">
            <NavLink to="/Form">
              <button className="bg-[#001DB0] hover:bg-blue-600 text-white px-6 py-3 rounded-lg text-lg">
                Book a Jet now!
              </button>
            </NavLink>
            <button className="bg-[#FF6D2E] hover:bg-orange-600 text-white px-6 py-3 rounded-lg text-lg">
             Book a Chopper now!
            </button>
          </div>
        </div>
