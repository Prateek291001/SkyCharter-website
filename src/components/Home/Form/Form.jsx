...
import CAPTCHA from 'react-google-recaptcha/lib/recaptcha';
    ...
    <>
      ...
      <div className='Box shadow-2xl  '>
        <div className='my-8 p-4 '>
          <h1 className='text-center text-4xl font-bold  text-[#0b2545] '>Send us a Message</h1>
          <p className='text-gray-600 mt-2 '>Please fill out the form below and a SkyCharter representative will follow up shortly regarding your custom private jet charter request.</p>
          ...
          <div className='agree  flex-col text-end pr-4 mt-4 '>
            ...
            <button className='w-80 h-12 bg-[#FF6D2E] rounded-md  hover:bg-orange-600 text-white mt-8 z-0 '>
              Submit
            </button>
          </div>
