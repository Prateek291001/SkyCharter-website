    ...
    <>
      <div>
        <div className='relative w-full h-auto mb-4  '>
          <img src="http://localhost:5173/src/components/Form/FormImg/im2.jpg" alt="Private Jet" className='w-full ' />
      ...
      <div className='Container mb-4 '>
        <div className='Box shadow-2xl  '>
          <div className='my-8 p-4 '>
            <h1 className='text-center text-4xl font-bold  text-[#0b2545] '>Request a Quote for a Private flight Rental</h1>
            <p className='text-gray-600 mt-2 '>Please fill out the form below and a Charter Jet One representative will follow up shortly regarding your custom private jet charter request.</p>
            <div className="flex flex-col md:flex-row pt-4 px-4 box-border w-full">
              ...
              <div className="flex w-full md:w-3/5 h-10 items-center bg-gray-300 mb-4 justify-between md:justify-end md:pl-4 pr-4">
                <div className="hidden md:block text-gray-400 text-lg font-normal">
                  *Requires Answer
                </div>
                <span className="md:hidden text-gray-400 text-lg font-normal">*</span>
              </div>
            </div>
